...
{
    public class AddValueGiftCardPaymentResponse : PaymentResponse
    {
        #region Constructors
        ...
        /// </summary>
        public AddValueGiftCardPaymentResponse() : base()
        {
        ...
        public AddValueGiftCardPaymentResponse(XDocument doc)
            : base(doc)
        {
