...
{
    public class BalanceGiftCardPaymentResponse : PaymentResponse
    {
        #region Constructors
        ...
        /// </summary>
        public BalanceGiftCardPaymentResponse() : base()
        {
        ...
        public BalanceGiftCardPaymentResponse(XDocument doc)
            : base(doc)
        {
