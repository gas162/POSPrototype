...
{
    public class DeactivateGiftCardPaymenResponse : PaymentResponse
    {
        #region Constructors
        ...
        /// </summary>
        public DeactivateGiftCardPaymenResponse() : base()
        {
        ...
        public DeactivateGiftCardPaymenResponse(XDocument doc)
            : base(doc)
        {
