...
{
    public class ActivateGiftCardPaymentRequest : PaymentRequest
    {
        /// <summary>
        /// Initializes an empty instance of the Activate Gift Card Payment Request message.
        /// </summary>
        public ActivateGiftCardPaymentRequest()
            : base()
        {
            Command = "ACTIVATE";
            PaymentType = "GIFT";
